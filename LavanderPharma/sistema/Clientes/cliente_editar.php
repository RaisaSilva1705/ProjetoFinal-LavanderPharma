...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE CLIENTES SET 
                ...
                Email_Cliente = ?, Tel_Cliente = ?, CEP = ?, Endereco_Cliente = ?, 
                EndNumero_Cliente = ?, Complemento_Cliente = ?, Bairro_Cliente = ?, Cidade_Cliente = ?, Estado_Cliente = ?, 
                DataNasc_Cliente = ?, Status_Cliente = ?, DataAlteracao_Cliente = NOW() 
            WHERE ID_Cliente = ?";
    ...
    $stmt->bind_param("sssssssssssssss", 
        ...
        $complemento, $bairro, $cidade, $estado, $nascimento, $status, $codigo_cliente);
